...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         ...
         <h3>We do not cook, we create your emotions!</h3>
         <p>It’s not true that money can’t buy happiness. I mean, have you tried homemade food? It’s the same thing!</p>
...
<section class="home-category">
   ...
   <h1 class="title">Eat what makes you happy</h1>

   <div class="box-container">
   <?php 
      $select_cat = $conn->prepare("SELECT * FROM `category_list` LIMIT 4");
      $select_cat->execute();
...
<section class="products">
   ...
   <h1 class="title">New Arrivals</h1><br><br>
